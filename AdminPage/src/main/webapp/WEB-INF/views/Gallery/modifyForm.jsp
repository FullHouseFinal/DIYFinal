                  ...
                  <div class="tab-pane fade active in" id="step2">
                     <div class="row" style="">
                        <div class="col-md-6"
                           ...
                           <!--          <table> -->
                           <%--             <tr><th>제목: <input type="text" value="${read.title}" id="" name="title"></th></tr> --%>
                           <%--             <tr><th>글쓴이: ${sessionScope.id}</th></tr> --%>
                           <%--             <tr><th>이미지: <input type="file" value="${read.imgUuid}" name="uploadFile"></th></tr> --%>
                           <%--             <tr><th>내용: <input type="text" value="${read.content}" name="content" id="content"></th></tr>  --%>
                           <%--             <tr><th><input type="hidden" value="${read.galleryNum}" name="galleryNum"></th></tr> --%>
                                 ...
                                 <tr>
                                    <td class="" style="width: 25%; padding: 30px;">
                                       ...
                                       <button type="button" class="button button--aylen btn"
                                          style="float: right; margin: 10px; display: inline; width: 79px; height: 45px;">Modify</button>
                                       <button type="button" class="button button--aylen btn"
                                          style="float: right; margin: 10px; display: inline; width: 79px; height: 45px;">Cancel</button>
                                    </td>
                                 </tr>
                              </tbody>
                           </table>
