	...
	<div data-brackets-id="23363" id="wrapper">
			...
			<div class="row" style="background-color: white">
				<div class="col-md-*"
					...
					<div id="myTabContent" class="tab-content">
						<form action="/admin/user/userUpdate" method="post" name="fm">
								...
								<div class="shopcart">
									<table class="table">
										<thead class="col-md-*" style="align-items: center">
											...
											<tr>
												<th>Password</th>
												<td><h4><input type="text" value="${userRead.pwd}" name="pwd" id="pwd" required="required"></h4></td>
											</tr>
											<tr>
												<th>Email</th>
												<td><h4><input type="text" value="${userRead.email}" name="email" id="email" required="required"></h4></td>
											</tr>
											<tr>
												<th>Gender</th>
							...
							<input type="hidden" name="id" value="${userRead.id}">
						</form>	
						<!-- end form -->
					</div>
				</div>
		...
		<div class="text-center"
			...
			<button type="submit" class="btn btn-shopcart"
				style="background-color: #89bbc4; border: #89bbc4;" id="userUpdate">Update
			</button>
		</div>
