...
<body style="overflow: visible">
	...
	<div id="wrapper">
		...
		<section class="lb section"
			...
			<div class="container">
					<form action="/admin/user/userIdSearchAction" method="post">
						<div class="row">
							<div class="col-md-8"
								...
								<table class="" style="width: 100%;">
									...
									<tr class="row">
										<td class="col-md-3"
											...
											type="text" class="form-control input-lg" id="name"
											name="name" placeholder="Name" style="margin-bottom: 10px;">
											<input type="date" class="form-control input-lg" id="birth"
											name="birth" placeholder="Id" style="margin-bottom: 10px;">
											<button type="submit"
