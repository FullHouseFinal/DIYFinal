...
<body style="overflow: visible;">
	<div id="wrapper">
		...
		<section class="section lb"
			style="padding-top: 30px; padding-bottom: 61px; z-index: 1; min-height: 600px;">
			<div class="container">
				<div class="checkout-tab">
					<div id="myTabContent" class="tab-content">
						...
						<!-- end step 1 -->
						<form action="/admin/user/joinUser" method="post" id="fm">
											...
											<tbody>
												<tr class="row">
													<td class="col-md-3" style="width: 50%;"><input
														type="text" class="form-control input-lg" id="id"
														name="id" placeholder="ID" style="margin-bottom: 10px;"><span
														id="checkId"
														...
														style="margin-bottom: 10px;"> <input type="email"
														...
														<input type="radio" name="gender" id="ch_women" value="w">여성
														<input type="radio" name="gender" id="ch_men" value="m">남성

														<input type="date" id="birth" name="birth"
														class="form-control input-lg" placeholder="ID"
														style="margin-bottom: 10px;">

														<button type="submit" id="join" disabled="disabled"
															class="button button--aylen btn"
															style="margin-top: 20px; width: 110px; height: 50px; font-size: 20px; border-radius: 35px;">Sign
															Up</button></td>
												</tr>
											</tbody>
										</table>
										<input type="hidden" name="action" value="joinUser">
										<!-- end widget-title -->
									</div>
									<!-- end col -->
								</div>
	...
	<script>
		$(function(){
			...
			$("#join").click(function(){
				...
				var name = $("#name");
				var email = $("#email");
				var gender = $('input[name=gender]:checked:checked').length;
			...
			$("#checkmail").click(function(){
				$.ajax({
					...
					success:function(result){  // val result = 3015
...
// 				height: 200,
	...
	<div class="modal ui-dialog-content ui-widget-content" id="modal"
		style="padding-top: 100px; left: 0px; top: 0px; background-color: rgba(0, 0, 0, 0.35); width: auto; height: -webkit-fill-available;">
		<div
				...
				<tbody>
					<tr class="row">
						<td class="col-md-3" style="width: 300px;"><span
							...
							name="author" placeholder="인증번호 입력"
