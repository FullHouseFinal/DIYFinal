						...
						<div class="tab-pane fade active in" id="step1">
							<div class="shopcart">
								<table class="table"
									...
									<thead>
										<tr>
											<th style="WIDTH: 10%;">가구 번호</th>
											<th style="WIDTH: 10%;">가구 회사</th>
											<th style="WIDTH: 15%;">가구 이름</th>
											<th style="WIDTH: 10%;">가구 종류</th>
											<th style="WIDTH: 13%;">가구 이미지</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${libraryList}" var="library">
											<tr>
												<td style="WIDTH: 10%;">${library.furnitureNum}</td>
												<td style="WIDTH: 10%;">${library.coNAME}</td>
												<td style="WIDTH: 15%;"><a href="/admin/file/libraryRead?furnitureNum=${library.furnitureNum}">${library.furnitureName}</a></td>
												<td style="WIDTH: 10%;">${library.type}</td>
												<td style="WIDTH: 13%;"><img src="/admin/resources/file/${library.imgPath}" ></td>			
											</tr>
										</c:forEach>
									</tbody>
								</table>
							...
							<div class="col-md-12">
								<nav class="text-center">
									<ul class="pagination" id="navigator">
										<li><a href="javascript:pageProc(${libraryNavi.currentPage - libraryNavi.pagePerGroup},'${libraryCondition}','${libraryKeyword}')"><i class="fa fa-fast-backward" aria-hidden="true"></i></a></li>
										<li><a href="javascript:pageProc(${libraryNavi.currentPage - 1},'${libraryCondition}','${libraryKeyword}')"><i class="fa fa-step-backward" aria-hidden="true"></i></a></li>
										<c:forEach begin="${libraryNavi.startPageGroup}" end="${libraryNavi.endPageGroup}" var="counter">
											<c:if test="${counter == libraryNavi.currentPage}"></c:if>
											<li><a href="javascript:pageProc(${counter},'${libraryCondition}','${libraryKeyword}')">${counter}</a></li>
											<c:if test="${counter == companyNavi.currentPage}"></c:if>
										</c:forEach>
										<li><a href="javascript:pageProc(${libraryNavi.currentPage + 1},'${libraryCondition}','${libraryKeyword}')"><i class="fa fa-step-forward" aria-hidden="true"></i></a></li>
										<li><a href="javascript:pageProc(${libraryNavi.currentPage + libraryNavi.pagePerGroup},'${libraryCondition}','${libraryKeyword}')"><i class="fa fa-fast-forward" aria-hidden="true"></i></a></li>
									</ul>
								</nav>
							</div>
							<div class="row">
