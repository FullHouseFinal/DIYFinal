...
<body data-brackets-id="23359" style="overflow: visible;">
	...
	<div data-brackets-id="23363" id="wrapper">
			...
			<div class="row" style="background-color: white">
				<div class="col-md-*"
					...
					<div id="myTabContent" class="tab-content">
						<form action="/admin/user/companyUpdate" method="post" name="fm">
								...
								<div class="shopcart">
									<table class="table">
										<thead class="col-md-*" style="align-items: center">
											<tr class="table">
												<th>Name</th>
												<td style="width: 10"><h4>${companyRead.coName}</h4></td>
											</tr>
											<tr>
												<th>Password</th>
												<td><h4>
														<input type="text" value="${companyId.coPwd}" name="coPwd"
											...
											<tr>
												<th>Tel</th>
												<td><h4>
														<input type="text" value="${companyId.coTel}" name="coTel"
															id="tel" required="required">
													</h4></td>
											</tr>
											<tr>
												<th>ManagerName</th>
												<td><h4>
														<input type="text" value="${companyId.coManagerName}"
															name="coManagerName" id="mname" required="required">
													</h4></td>
											</tr>
											<tr>
												<th>ManagerDepartment</th>
												<td><h4>
														<input type="text" value="${companyId.coManagerDept}"
															name="coManagerDept" id="mdept" required="required">
													</h4></td>
											</tr>
											<tr>
												<th>ManagerEmail</th>
												<td><h4>
														<input type="text" value="${companyId.coManagerEmail}"
															name="coManagerEmail" id="memail" required="required">
													</h4></td>
											</tr>
											<tr>
												<th>Authority</th>
												<td><h4>${companyRead.coAuthority}</h4></td>
											</tr>
										</thead>
									</table>
								</div>
							</div>
							<input type="hidden" name="coId" value="${companyRead.coId}">
						</form>
						<!-- end form -->
					</div>
				</div>
		...
		<script data-brackets-id="23618"
			src="/admin/resources/js/bootstrap.min.js"></script>
		...
		<script data-brackets-id="23622"
			src="/admin/resources/js/tether.min.js"></script>
		<!-- MAP & CONTACT -->
	...
	<script>
		$(function(){
			$("#companyUpdate").click(function(){
				var result = confirm("Would you like to modify it?");
				if(result){
					alert("Complete revision!");
					document.fm.submit();
				}
			});
		});
